...
if __name__ == "__main__":
    ...
    parser.add_argument("--offline", action="store_true", help="Generate for offline use")
    parser.add_argument("--notebook", action="store_true", help="Generate for HTML embedding in notebook")
    args = parser.parse_args()
    
    doc = Document.load(args.infile, fmt="json")
    html = doc.save_mem(fmt="html-ann-viewer", offline=args.offline, notebook=args.notebook)
