...
<div><style>#WSGEELJMHP-wrapper { color: black !important; }</style>
<div id="WSGEELJMHP-wrapper">
...
.WSGEELJMHP-selection {
    margin-bottom: 5px;
}

.WSGEELJMHP-featuretable {
    margin-top: 10px;
}
...
.WSGEELJMHP-fvalue {
  ...
  <div id="WSGEELJMHP-content">
        <div id="WSGEELJMHP-popup" style="display: none;">
        </div>
        <div class="WSGEELJMHP-row" id="WSGEELJMHP-row1" style="height:67vh; min-height:100px;">
            <div id="WSGEELJMHP-text-wrapper" class="WSGEELJMHP-col" style="width:70%;">
                <div class="WSGEELJMHP-hdr" id="WSGEELJMHP-dochdr"></div>
                <div id="WSGEELJMHP-text">
                </div>
            </div>
            <div id="WSGEELJMHP-chooser" class="WSGEELJMHP-col" style="width:30%; border-left-width: 0px;"></div>
        </div>
        <div class="WSGEELJMHP-row" id="WSGEELJMHP-row2" style="height:30vh; min-height: 100px;">
            <div id="WSGEELJMHP-details" class="WSGEELJMHP-col" style="width:100%; border-top-width: 0px;">
            </div>
        </div>
    </div>

    <script type="application/json" id="WSGEELJMHP-data">
