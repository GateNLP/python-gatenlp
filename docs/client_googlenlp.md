...
<div><style>#BKAPRKDHWM-wrapper { color: black !important; }</style>
<div id="BKAPRKDHWM-wrapper">
...
.BKAPRKDHWM-selection {
    margin-bottom: 5px;
}

.BKAPRKDHWM-featuretable {
    margin-top: 10px;
}
...
.BKAPRKDHWM-fvalue {
  ...
  <div id="BKAPRKDHWM-content">
        <div id="BKAPRKDHWM-popup" style="display: none;">
        </div>
        <div class="BKAPRKDHWM-row" id="BKAPRKDHWM-row1" style="min-height:5em;max-height:20em; min-height:5em;">
            <div id="BKAPRKDHWM-text-wrapper" class="BKAPRKDHWM-col" style="width:70%;">
                <div class="BKAPRKDHWM-hdr" id="BKAPRKDHWM-dochdr"></div>
                <div id="BKAPRKDHWM-text" style="">
                </div>
            </div>
            <div id="BKAPRKDHWM-chooser" class="BKAPRKDHWM-col" style="width:30%; border-left-width: 0px;"></div>
        </div>
        <div class="BKAPRKDHWM-row" id="BKAPRKDHWM-row2" style="min-height:3em;max-height:14em; min-height: 3em;">
            <div id="BKAPRKDHWM-details" class="BKAPRKDHWM-col" style="width:100%; border-top-width: 0px;">
            </div>
        </div>
    </div>

    <script type="text/javascript">
    let BKAPRKDHWM_data = {"annotation_sets": {}, "text": "\nThis is just some example text. It mentions the name US President Barack Obama and the \ncompanies Microsoft, IBM, Google as well as a few place names like Los Angeles and New York.\nIt has strange characters like \ud83d\udca9 and emojis like \ud83d\ude0a and \ud83d\ude02.\nHere we mention Barack Obama again and here we mention Charlie Chaplin.\nIt mentions mathematics and economy and the terms cloud computing and gene therapy.\nJohn Smith beat Harald Schmidt at the tennis tournament.\n", "features": {}, "offset_type": "j", "name": ""} ; 
    let BKAPRKDHWM_parms = {"presel_set": [], "presel_list": [], "cols4types": {}} ;
    new gatenlpDocView(new gatenlpDocRep(BKAPRKDHWM_data, BKAPRKDHWM_parms), "BKAPRKDHWM-").init();
    </script>
  </div>
...
<div><style>#CGWRNRCNUM-wrapper { color: black !important; }</style>
<div id="CGWRNRCNUM-wrapper">
...
.CGWRNRCNUM-selection {
    margin-bottom: 5px;
}

.CGWRNRCNUM-featuretable {
    margin-top: 10px;
}
