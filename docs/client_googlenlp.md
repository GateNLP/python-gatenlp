...
<div><style>#DDHJXVMRWW-wrapper { color: black !important; }</style>
<div id="DDHJXVMRWW-wrapper">
...
.DDHJXVMRWW-selection {
    margin-bottom: 5px;
}

.DDHJXVMRWW-featuretable {
    margin-top: 10px;
}
...
.DDHJXVMRWW-fvalue {
  ...
  <div id="DDHJXVMRWW-content">
        <div id="DDHJXVMRWW-popup" style="display: none;">
        </div>
        <div class="DDHJXVMRWW-row" id="DDHJXVMRWW-row1" style="min-height:5em;max-height:20em; min-height:5em;">
            <div id="DDHJXVMRWW-text-wrapper" class="DDHJXVMRWW-col" style="width:70%;">
                <div class="DDHJXVMRWW-hdr" id="DDHJXVMRWW-dochdr"></div>
                <div id="DDHJXVMRWW-text" style="">
                </div>
            </div>
            <div id="DDHJXVMRWW-chooser" class="DDHJXVMRWW-col" style="width:30%; border-left-width: 0px;"></div>
        </div>
        <div class="DDHJXVMRWW-row" id="DDHJXVMRWW-row2" style="min-height:3em;max-height:14em; min-height: 3em;">
            <div id="DDHJXVMRWW-details" class="DDHJXVMRWW-col" style="width:100%; border-top-width: 0px;">
            </div>
        </div>
    </div>

    <script type="text/javascript">
    let DDHJXVMRWW_data = {"annotation_sets": {}, "text": "\nThis is just some example text. It mentions the name US President Barack Obama and the \ncompanies Microsoft, IBM, Google as well as a few place names like Los Angeles and New York.\nIt has strange characters like \ud83d\udca9 and emojis like \ud83d\ude0a and \ud83d\ude02.\nHere we mention Barack Obama again and here we mention Charlie Chaplin.\nIt mentions mathematics and economy and the terms cloud computing and gene therapy.\nJohn Smith beat Harald Schmidt at the tennis tournament.\n", "features": {}, "offset_type": "j", "name": ""} ; 
    let DDHJXVMRWW_parms = {"presel_set": [], "presel_list": [], "cols4types": {}} ;
    new gatenlpDocView(new gatenlpDocRep(DDHJXVMRWW_data, DDHJXVMRWW_parms), "DDHJXVMRWW-").init();
    </script>
  </div>
...
<div><style>#LRLRINJSDB-wrapper { color: black !important; }</style>
<div id="LRLRINJSDB-wrapper">
...
.LRLRINJSDB-selection {
    margin-bottom: 5px;
}

.LRLRINJSDB-featuretable {
    margin-top: 10px;
}
