...
Some tokenize methods need to run on sentences instead of full documents, for this it is possible to specify an object/function that splits the document into sentences first (this is only used for the `tokenize` method, not the `span_tokenize` method)
...
<div><style>#LUBXDNYDAM-wrapper { color: black !important; }</style>
<div id="LUBXDNYDAM-wrapper">
...
.LUBXDNYDAM-selection {
    margin-bottom: 5px;
}

.LUBXDNYDAM-featuretable {
    margin-top: 10px;
}
...
.LUBXDNYDAM-fvalue {
  ...
  <div id="LUBXDNYDAM-content">
        <div id="LUBXDNYDAM-popup" style="display: none;">
        </div>
        <div class="LUBXDNYDAM-row" id="LUBXDNYDAM-row1" style="max-height: 20em; min-height:5em;">
            <div id="LUBXDNYDAM-text-wrapper" class="LUBXDNYDAM-col" style="width:70%;">
                <div class="LUBXDNYDAM-hdr" id="LUBXDNYDAM-dochdr"></div>
                <div id="LUBXDNYDAM-text" style="">
                </div>
            </div>
            <div id="LUBXDNYDAM-chooser" class="LUBXDNYDAM-col" style="width:30%; border-left-width: 0px;"></div>
        </div>
        <div class="LUBXDNYDAM-row" id="LUBXDNYDAM-row2" style="max-height: 14em; min-height: 3em;">
            <div id="LUBXDNYDAM-details" class="LUBXDNYDAM-col" style="width:100%; border-top-width: 0px;">
            </div>
        </div>
    </div>

    <script type="text/javascript">
    let LUBXDNYDAM_data = {"annotation_sets": {}, "text": "Barack Obama was the 44th president of the US and he followed George W. Bush and\n  was followed by Donald Trump. Before Bush, Bill Clinton was president.\n  Also, lets include a sentence about South Korea which is called \ub300\ud55c\ubbfc\uad6d in Korean.\n  And a sentence with the full name of Iran in Farsi: \u062c\u0645\u0647\u0648\u0631\u06cc \u0627\u0633\u0644\u0627\u0645\u06cc \u0627\u06cc\u0631\u0627\u0646 and also with \n  just the word \"Iran\" in Farsi: \u0627\u06cc\u0631\u0627\u0646 \n  Also barack obama in all lower case and SOUTH KOREA in all upper case\n  ", "features": {}, "offset_type": "j", "name": ""} ; 
    new gatenlpDocView(new gatenlpDocRep(LUBXDNYDAM_data), "LUBXDNYDAM-").init();
    </script>
  </div>
...
<div><style>#YENPUBLOPB-wrapper { color: black !important; }</style>
<div id="YENPUBLOPB-wrapper">
...
.YENPUBLOPB-selection {
    margin-bottom: 5px;
}

.YENPUBLOPB-featuretable {
    margin-top: 10px;
}
...
### Use the NLTK TreebankWordTokenizer

The NLTK TreebankWordTokenizer needs to be run on individual sentences, so we also use the NLTK PunktSentenceTokenizer
...
tok2 = NLTKTokenizer(nltk_tokenizer=TreebankWordTokenizer(), nltk_sent_tokenizer=PunktSentenceTokenizer())
doc2 = Document(text)
doc2 = tok2(doc2)
doc2
```
...
<div><style>#QCIOCGDGTT-wrapper { color: black !important; }</style>
<div id="QCIOCGDGTT-wrapper">
...
.QCIOCGDGTT-selection {
    margin-bottom: 5px;
}

.QCIOCGDGTT-featuretable {
    margin-top: 10px;
}
...
.QCIOCGDGTT-fvalue {
  ...
  <div id="QCIOCGDGTT-content">
        <div id="QCIOCGDGTT-popup" style="display: none;">
        </div>
        <div class="QCIOCGDGTT-row" id="QCIOCGDGTT-row1" style="max-height: 20em; min-height:5em;">
            <div id="QCIOCGDGTT-text-wrapper" class="QCIOCGDGTT-col" style="width:70%;">
                <div class="QCIOCGDGTT-hdr" id="QCIOCGDGTT-dochdr"></div>
                <div id="QCIOCGDGTT-text" style="">
                </div>
            </div>
            <div id="QCIOCGDGTT-chooser" class="QCIOCGDGTT-col" style="width:30%; border-left-width: 0px;"></div>
        </div>
        <div class="QCIOCGDGTT-row" id="QCIOCGDGTT-row2" style="max-height: 14em; min-height: 3em;">
            <div id="QCIOCGDGTT-details" class="QCIOCGDGTT-col" style="width:100%; border-top-width: 0px;">
            </div>
        </div>
    </div>
    ...
    new gatenlpDocView(new gatenlpDocRep(QCIOCGDGTT_data), "QCIOCGDGTT-").init();
    </script>
  </div>
...
<div><style>#GEWDTUSRNS-wrapper { color: black !important; }</style>
<div id="GEWDTUSRNS-wrapper">
...
.GEWDTUSRNS-selection {
    margin-bottom: 5px;
}

.GEWDTUSRNS-featuretable {
    margin-top: 10px;
}
...
```
    ...
    2021-10-31 15:24:07,274|INFO|stanza|Loading these models for language: en (English):
    ========================
    | Processor | Package  |
    ------------------------
    | tokenize  | combined |
    ...
    2021-10-31 15:24:07,274|INFO|stanza|Use device: cpu
    2021-10-31 15:24:07,275|INFO|stanza|Loading: tokenize
    2021-10-31 15:24:07,280|INFO|stanza|Done loading processors!





<div><style>#VDNCVEWFYI-wrapper { color: black !important; }</style>
<div id="VDNCVEWFYI-wrapper">
...
.VDNCVEWFYI-selection {
    margin-bottom: 5px;
}

.VDNCVEWFYI-featuretable {
    margin-top: 10px;
}
