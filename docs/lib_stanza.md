...
```
    ...
    Downloading https://raw.githubusercontent.com/stanfordnlp/stanza-resources/master/resources_1.1.0.json: 122kB [00:00, 6.68MB/s]                    
    2020-11-12 18:41:28,089|INFO|stanza|Downloading default packages for language: en (English)...
    2020-11-12 18:41:31,902|INFO|stanza|File exists: /home/johann/stanza_resources/en/default.zip.
    2020-11-12 18:41:37,143|INFO|stanza|Finished downloading models and saved to /home/johann/stanza_resources.
...
<div><style>#XHHLZZJQVY-wrapper { color: black !important; }</style>
<div id="XHHLZZJQVY-wrapper">
...
.XHHLZZJQVY-selection {
    margin-bottom: 5px;
}

.XHHLZZJQVY-featuretable {
    margin-top: 10px;
}
...
.XHHLZZJQVY-fvalue {
  ...
  <div id="XHHLZZJQVY-content">
        <div id="XHHLZZJQVY-popup" style="display: none;">
        </div>
        <div class="XHHLZZJQVY-row" id="XHHLZZJQVY-row1" style="height:67vh; min-height:100px;">
            <div id="XHHLZZJQVY-text-wrapper" class="XHHLZZJQVY-col" style="width:70%;">
                <div class="XHHLZZJQVY-hdr" id="XHHLZZJQVY-dochdr"></div>
                <div id="XHHLZZJQVY-text">
                </div>
            </div>
            <div id="XHHLZZJQVY-chooser" class="XHHLZZJQVY-col" style="width:30%; border-left-width: 0px;"></div>
        </div>
        <div class="XHHLZZJQVY-row" id="XHHLZZJQVY-row2" style="height:30vh; min-height: 100px;">
            <div id="XHHLZZJQVY-details" class="XHHLZZJQVY-col" style="width:100%; border-top-width: 0px;">
            </div>
        </div>
    </div>

    <script type="application/json" id="XHHLZZJQVY-data">
...
```
    ...
    2020-11-12 18:41:37,693|INFO|stanza|Loading these models for language: en (English):
    =========================
    | Processor | Package   |
    -------------------------
    | tokenize  | ewt       |
    ...
    2020-11-12 18:41:37,694|INFO|stanza|Use device: cpu
    2020-11-12 18:41:37,695|INFO|stanza|Loading: tokenize
    2020-11-12 18:41:37,701|INFO|stanza|Loading: pos
    2020-11-12 18:41:38,404|INFO|stanza|Loading: lemma
    2020-11-12 18:41:38,429|INFO|stanza|Loading: depparse
    2020-11-12 18:41:39,274|INFO|stanza|Loading: sentiment
    2020-11-12 18:41:40,182|INFO|stanza|Loading: ner
    2020-11-12 18:41:40,730|INFO|stanza|Done loading processors!
...
<div><style>#RCBLGAJCZO-wrapper { color: black !important; }</style>
<div id="RCBLGAJCZO-wrapper">
...
.RCBLGAJCZO-selection {
    margin-bottom: 5px;
}

.RCBLGAJCZO-featuretable {
    margin-top: 10px;
}
...
.RCBLGAJCZO-fvalue {
  ...
  <div id="RCBLGAJCZO-content">
        <div id="RCBLGAJCZO-popup" style="display: none;">
        </div>
        <div class="RCBLGAJCZO-row" id="RCBLGAJCZO-row1" style="height:67vh; min-height:100px;">
            <div id="RCBLGAJCZO-text-wrapper" class="RCBLGAJCZO-col" style="width:70%;">
                <div class="RCBLGAJCZO-hdr" id="RCBLGAJCZO-dochdr"></div>
                <div id="RCBLGAJCZO-text">
                </div>
            </div>
            <div id="RCBLGAJCZO-chooser" class="RCBLGAJCZO-col" style="width:30%; border-left-width: 0px;"></div>
        </div>
        <div class="RCBLGAJCZO-row" id="RCBLGAJCZO-row2" style="height:30vh; min-height: 100px;">
            <div id="RCBLGAJCZO-details" class="RCBLGAJCZO-col" style="width:100%; border-top-width: 0px;">
            </div>
        </div>
    </div>

    <script type="application/json" id="RCBLGAJCZO-data">
