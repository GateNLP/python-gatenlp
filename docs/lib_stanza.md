...
```
    ...
    2022-06-28 20:20:59,263|INFO|stanza|Downloading default packages for language: en (English)...
    2022-06-28 20:21:03,069|INFO|stanza|File exists: /data/johann/stanza_resources/en/default.zip.
    2022-06-28 20:21:15,706|INFO|stanza|Finished downloading models and saved to /data/johann/stanza_resources.
...
<div><style>#DUFEWWAUKM-wrapper { color: black !important; }</style>
<div id="DUFEWWAUKM-wrapper">
...
.DUFEWWAUKM-selection {
    margin-bottom: 5px;
}

.DUFEWWAUKM-featuretable {
    margin-top: 10px;
}
...
.DUFEWWAUKM-fvalue {
  ...
  <div id="DUFEWWAUKM-content">
        <div id="DUFEWWAUKM-popup" style="display: none;">
        </div>
        <div class="DUFEWWAUKM-row" id="DUFEWWAUKM-row1" style="min-height:5em;max-height:20em; min-height:5em;">
            <div id="DUFEWWAUKM-text-wrapper" class="DUFEWWAUKM-col" style="width:70%;">
                <div class="DUFEWWAUKM-hdr" id="DUFEWWAUKM-dochdr"></div>
                <div id="DUFEWWAUKM-text" style="">
                </div>
            </div>
            <div id="DUFEWWAUKM-chooser" class="DUFEWWAUKM-col" style="width:30%; border-left-width: 0px;"></div>
        </div>
        <div class="DUFEWWAUKM-row" id="DUFEWWAUKM-row2" style="min-height:3em;max-height:14em; min-height: 3em;">
            <div id="DUFEWWAUKM-details" class="DUFEWWAUKM-col" style="width:100%; border-top-width: 0px;">
            </div>
        </div>
    </div>

    <script type="text/javascript">
    let DUFEWWAUKM_data = {"annotation_sets": {}, "text": "This is just a sample document for experimenting with gatenlp. \nIt mentions a few named entities like the persons Barack Obama, \nAlbert Einstein and Wolfgang Amadeus Mozart and the geographical \nlocations and countries America, United States of America, \nHungary, the Atlantic Ocean, and Helskinki. \n\nIt also contains mentions of various numbers and amounts like \n12 degrees, 12.83$, 25 km/h or fortytwo kilos and mentions\norganizations and companies like the UNO, Microsoft, Apple, which\nhas an apple as it's logo, or Google. \n\n\n", "features": {}, "offset_type": "j", "name": ""} ; 
    let DUFEWWAUKM_parms = {"presel_set": [], "presel_list": [], "cols4types": {}} ;
    new gatenlpDocView(new gatenlpDocRep(DUFEWWAUKM_data, DUFEWWAUKM_parms), "DUFEWWAUKM-").init();
    </script>
  </div>
...
```
    ...
    2022-06-28 20:21:16,002|INFO|stanza|Loading these models for language: en (English):
    ============================
    | Processor    | Package   |
    ----------------------------
    | tokenize     | combined  |
    ...
    2022-06-28 20:21:16,005|INFO|stanza|Use device: cpu
    2022-06-28 20:21:16,006|INFO|stanza|Loading: tokenize
    2022-06-28 20:21:16,036|INFO|stanza|Loading: pos
    2022-06-28 20:21:16,321|INFO|stanza|Loading: lemma
    2022-06-28 20:21:16,429|INFO|stanza|Loading: depparse
    2022-06-28 20:21:16,894|INFO|stanza|Loading: sentiment
    2022-06-28 20:21:17,298|INFO|stanza|Loading: constituency
    2022-06-28 20:21:17,727|INFO|stanza|Loading: ner
    2022-06-28 20:21:18,241|INFO|stanza|Done loading processors!
...
<div><style>#YAKVMTOVDO-wrapper { color: black !important; }</style>
<div id="YAKVMTOVDO-wrapper">
...
.YAKVMTOVDO-selection {
    margin-bottom: 5px;
}

.YAKVMTOVDO-featuretable {
    margin-top: 10px;
}
