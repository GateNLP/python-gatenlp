...
<div><style>#FLRPDXJCVU-wrapper { color: black !important; }</style>
<div id="FLRPDXJCVU-wrapper">
...
.FLRPDXJCVU-selection {
    margin-bottom: 5px;
}

.FLRPDXJCVU-featuretable {
    margin-top: 10px;
}
...
.FLRPDXJCVU-fvalue {
  ...
  <div id="FLRPDXJCVU-content">
        <div id="FLRPDXJCVU-popup" style="display: none;">
        </div>
        <div class="FLRPDXJCVU-row" id="FLRPDXJCVU-row1" style="min-height:5em;max-height:20em; min-height:5em;">
            <div id="FLRPDXJCVU-text-wrapper" class="FLRPDXJCVU-col" style="width:70%;">
                <div class="FLRPDXJCVU-hdr" id="FLRPDXJCVU-dochdr"></div>
                <div id="FLRPDXJCVU-text" style="">
                </div>
            </div>
            <div id="FLRPDXJCVU-chooser" class="FLRPDXJCVU-col" style="width:30%; border-left-width: 0px;"></div>
        </div>
        <div class="FLRPDXJCVU-row" id="FLRPDXJCVU-row2" style="min-height:3em;max-height:14em; min-height: 3em;">
            <div id="FLRPDXJCVU-details" class="FLRPDXJCVU-col" style="width:100%; border-top-width: 0px;">
            </div>
        </div>
    </div>
...
```python
gs = GateWorker(port=31333, start=False, auth_token="even-more-secret")
gs
```
    ...
    Gateworker(port=31333,host=127.0.0.1,gate_home=None)
...
```
    ...
    2022-06-28 00:17:02,416|INFO|gatenlp.gateworker.gateworker|Port 25333 is already in use
    ...
    PythonWorkerRunner.java: starting server with 25334/127.0.0.1/my-super-secret-auth-token/false
...
```
    ...
    PythonWorkerRunner.java: starting server with 25334/127.0.0.1/4FcwClpq5VoZuTbVoeCcIhOEXXk/false
    Java GatenlpWorker ENDING: 789880
...
```
    ...
    PythonWorkerRunner.java: starting server with 25334/127.0.0.1/tT2UExA3HiO7RmOkTNpunHtgFro/false


    CREOLE plugin loaded: ANNIE 9.0


    Java GatenlpWorker ENDING: 789905
...
<div><style>#QUUNRNTKZE-wrapper { color: black !important; }</style>
<div id="QUUNRNTKZE-wrapper">
...
.QUUNRNTKZE-selection {
    margin-bottom: 5px;
}

.QUUNRNTKZE-featuretable {
    margin-top: 10px;
}
...
.QUUNRNTKZE-fvalue {
  ...
  <div id="QUUNRNTKZE-content">
        <div id="QUUNRNTKZE-popup" style="display: none;">
        </div>
        <div class="QUUNRNTKZE-row" id="QUUNRNTKZE-row1" style="min-height:5em;max-height:20em; min-height:5em;">
            <div id="QUUNRNTKZE-text-wrapper" class="QUUNRNTKZE-col" style="width:70%;">
                <div class="QUUNRNTKZE-hdr" id="QUUNRNTKZE-dochdr"></div>
                <div id="QUUNRNTKZE-text" style="">
                </div>
            </div>
            <div id="QUUNRNTKZE-chooser" class="QUUNRNTKZE-col" style="width:30%; border-left-width: 0px;"></div>
        </div>
        <div class="QUUNRNTKZE-row" id="QUUNRNTKZE-row2" style="min-height:3em;max-height:14em; min-height: 3em;">
            <div id="QUUNRNTKZE-details" class="QUUNRNTKZE-col" style="width:100%; border-top-width: 0px;">
            </div>
        </div>
    </div>
